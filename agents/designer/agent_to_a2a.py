"""
Custom Agent-to-A2A conversion utility
Supports public_url parameter for Cloud Run deployments
Based on agentverse-architect reference implementation
"""
...
def to_a2a(
    ...
    Args:
        ...
        public_url: Optional full public URL (e.g., https://service-name-xxx.region.run.app)
    ...
    Example:
        agent = MyAgent()
        app = to_a2a(agent, public_url="https://my-service-xxx.us-central1.run.app")
        # Then run with: uvicorn module:app --host 0.0.0.0 --port 8080
    """
